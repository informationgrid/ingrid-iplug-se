...
startIplug()
{
  ...
  nohup bin/nutch de.ingrid.iplug.PlugServer --plugdescription conf/plugdescription-search.xml --descriptor conf/communication-search.xml > logs/console-search.log &
