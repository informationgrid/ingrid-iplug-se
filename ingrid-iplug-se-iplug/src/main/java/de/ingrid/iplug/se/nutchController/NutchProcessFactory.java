...
//                "Defines the index type of the indexed documents. The instance name will be used to be able to quickly manipulate all urls of an instance. This property only applies for the ingrid.indexer.elastic plugin.");
        ...
        nutchConfigTool.addOrUpdateProperty("iplug.datasource.name", SEIPlug.baseConfig.datasourceName, "The name of the iPlug which will be added to each indexed document.");
        nutchConfigTool.addOrUpdateProperty("iplug.id", SEIPlug.baseConfig.communicationProxyUrl, "The id of the iPlug which will be added to each indexed document.");
        ...
        nutchConfigTool.addOrUpdateProperty("communication.file", new File(SEIPlug.baseConfig.communicationLocation).getAbsolutePath(), "");
