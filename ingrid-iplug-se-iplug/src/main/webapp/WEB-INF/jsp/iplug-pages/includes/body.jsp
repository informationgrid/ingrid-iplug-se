...
<div id="contentBox" class="contentMiddle">
    ...
    <div id="tab-container" class="tab-container">
        <ul class='etabs'>
            ...
            <li class='tab<c:if test="${activeTab == '4'}"> active</c:if>'><a<c:if test="${activeTab != '4'}"> href="instanceStatus.html?instance=${instance.name}"</c:if>>Status</a></li>
        </ul>
        <div class="panel-container">
            <div id="tab-config">
                ...
                <c:if test="${activeTab == '4'}"><c:import url="includes/status.jsp"></c:import></c:if>
            </div>
        </div>
    </div>
</div>
