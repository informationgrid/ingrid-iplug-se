...
public class SnsIndexingPluginTest extends TestCase {
  ...
  public void testBuzzwords() throws Exception {
    ...
    document = new IndexingFilters(this.fConfiguration).filter(document, snsParseImpl, null, null, null);
    assertEquals("buzza", document.getFieldValues("buzzword").get(0));
    assertEquals("buzzb", document.getFieldValues("buzzword").get(1));
  }
  ...
  public void testDates() throws Exception {
    ...
    assertEquals("T01-0", document.getFieldValues("t0").get(1));
    assertEquals("T01-1", document.getFieldValues("t0").get(0));
    assertEquals("T1b", document.getFieldValues("t1").get(0));
    assertEquals("T2b", document.getFieldValues("t2").get(0));
    assertEquals("T1a", document.getFieldValues("t1").get(1));
    assertEquals("T2a", document.getFieldValues("t2").get(1));
  }
