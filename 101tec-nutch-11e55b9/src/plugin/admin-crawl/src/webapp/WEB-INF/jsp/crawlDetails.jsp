...
<head>
    ...
    <link rel="stylesheet" type="text/css" href="../theme/${theme}/js/yui/build/reset-fonts-grids/reset-fonts-grids.css" />
...
<div id="doc2">                 
    ...
    <div id="bd">
        <div id="yui-main" class="yui-t4">
          ...
          <c:if test="${noStatistics}">
             <p class="error">Latest statistic is not ready yet!</p>
          </c:if>
