...
<head>
	...
	<script type="text/javascript" src="../theme/${theme}/js/yui/build/charts/charts-min.js"></script> 
			...
			<div id="yui-main">
				<div class="yui-b">
					...
					<script type="text/javascript">
						...
						YAHOO.widget.Chart.SWFURL = "./theme/${theme}/js/yui/build/charts/assets/charts.swf";
