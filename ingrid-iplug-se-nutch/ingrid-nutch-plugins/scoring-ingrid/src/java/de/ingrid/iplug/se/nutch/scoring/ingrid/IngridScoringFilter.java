package de.ingrid.iplug.se.nutch.scoring.ingrid;
...
/**
 * <p>
 * This ingrid specific scoring filter combines the strategy of a
 * {@link DepthScoringFilter} scoring filter with a
 * {@link LinkAnalysisScoringFilter} scoring filter.
 * </p>
 * <p>
 ...
 * </p>
 * <p>
 * Because the DepthScoringFilter returns always 1.0 as indexing score the
 * linkage between the urls is not taken into account while indexing. This
 * {@link ScoringFilter} uses the same strategy for index scoring as the
 * {@link LinkAnalysisScoringFilter} and passes the {@link CrawlDatum} score
 * multiplied by an normalizedScore <code>link.analyze.normalize.score</code>
 * that defaults to 1.0.
 * </p>
 */
public class IngridScoringFilter extends Configured implements ScoringFilter {
    ...
    public void initialScore(Text url, CrawlDatum datum) throws ScoringFilterException {
        ...
        // take this from the LinkAnalysisScoringFilter, set initial scores to
        // 0.0, scoring will be computed by the webgraph.
        datum.setScore(0.0f);
    }
    ...
    public void passScoreAfterParsing(Text url, Content content, Parse parse) throws ScoringFilterException {
        ...
        // take this from the LinkAnalysisScoringFilter
