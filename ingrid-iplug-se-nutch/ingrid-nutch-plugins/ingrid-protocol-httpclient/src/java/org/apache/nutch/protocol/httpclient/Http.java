...
public class Http extends HttpBase {
  ...
  private boolean acceptInvalidSSLCertificates = false;
  ...
  public void setConf(Configuration conf) {
    ...
    this.acceptInvalidSSLCertificates = conf.getBoolean( "ingrid.accept.invalid.ssl.certificates", false ); 
  ...
  private void configureClient() {
    ...
    if (acceptInvalidSSLCertificates) {
