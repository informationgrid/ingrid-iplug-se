...
@Controller
public class DeleteWebUrlController {
  ...
  @Autowired
  public DeleteWebUrlController(IStartUrlDao startUrlDao, ILimitUrlDao limitUrlDao, IExcludeUrlDao excludeUrlDao) {
  ...
  public String deleteWebUrl(@RequestParam(value = "id", required = true) final Long id) {
