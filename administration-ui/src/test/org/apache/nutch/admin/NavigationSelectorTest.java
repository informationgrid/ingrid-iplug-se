...
public class NavigationSelectorTest extends TestCase {
  ...
  public void testSelectNavigation() throws Exception {
    ...
    Set<Navigation> selectNavigations = navigationSelector.selectComponentNavigation(
    ...
    selectNavigations = navigationSelector.selectInstanceNavigation(contextNames);
